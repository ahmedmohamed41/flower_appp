...
class _CartApiClient implements CartApiClient {
  ...
  @override
  Future<CartResponseDto> getCartItems() async {
  ...
  @override
  Future<CartResponseDto> addItemToCart(AddToCartRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<CartResponseDto> removeItemFromCart(String productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
