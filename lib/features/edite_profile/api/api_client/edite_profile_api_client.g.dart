...
part of 'edite_profile_api_client.dart';
...
class _ProfileApiClient implements ProfileApiClient {
  ...
  @override
  Future<UserProfileDto> editProfile(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<UserProfileDto> uploadPhoto(MultipartFile photo) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
