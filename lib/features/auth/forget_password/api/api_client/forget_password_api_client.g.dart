...
class _ForgetPasswordApiClient implements ForgetPasswordApiClient {
  ...
  Future<EnterResetEmailDTO> enterResetEmail(
    ...
    final _options = _setStreamType<EnterResetEmailDTO>(
    ...
    late EnterResetEmailDTO _value;
    try {
      _value = EnterResetEmailDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<ResetPasswordDTO> resetPassword(ResetPasswordRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
